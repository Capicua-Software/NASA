...
namespace NASA.ViewModels
{
    ...
    public class LoggedInPageViewModel : BaseViewModel
    {
        ...
        private static LoggedInPageViewModel healthProfileViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="LoggedInPageViewModel" /> class.
        /// </summary>
        ...
        /// </summary>
        public static LoggedInPageViewModel BindingContext =>
            healthProfileViewModel = PopulateData<LoggedInPageViewModel>("profile.json");
